...
function usersFn(persons) {
    ...
    for (const person of persons) {
        ...
        div.innerHTML = `${person.id} . ${person.name}`;
        let elementBut = document.createElement('button');
        elementBut.innerText = 'push me';
        container.append(div);
        div.append(elementBut);

        elementBut.addEventListener('click', () => {
